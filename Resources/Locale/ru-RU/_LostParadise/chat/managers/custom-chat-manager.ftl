...
chat-emote-msg-deathgasp = делает последний вздох, {POSS-ADJ($entity)} глаза мертвые и безжизненные...
chat-emote-msg-deathgasp-monkey = издает слабый звук, когда {SUBJECT($entity)} сворачивается и перестает двигаться...
