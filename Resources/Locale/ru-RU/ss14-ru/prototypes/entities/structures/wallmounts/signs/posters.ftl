...
ent-PosterLegitNanotrasenLogo = Логотип Voidkol
...
ent-PosterLegitVacation = Корпоративные привилегии Voidkol: Отпуск
    .desc = На этом информационном плакате представлена информация о некоторых призах, которые можно получить в рамках программы 'Корпоративные привилегии Voidkol', включая двухнедельный отпуск на двоих на планете-курорте Идиллус.
