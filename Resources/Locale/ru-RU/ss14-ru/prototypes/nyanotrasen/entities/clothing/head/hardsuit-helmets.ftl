...
ent-ClothingHeadHelmetHardsuitSyndieReverseEngineered = Шлем NTSA-122
    .desc = Прочный легковесный шлем, созданный департаментом особых приобретений Voidkol.
ent-ClothingHeadHelmetHardsuitJuggernautReverseEngineered = Шлем NTSA-126
    .desc = Сверхпрочный шлем, созданный департаментом особых приобретений Voidkol, основываясь на модели "Juggernaut".
